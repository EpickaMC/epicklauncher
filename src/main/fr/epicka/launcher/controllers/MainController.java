...
public class MainController {
    ...
    public void onAuthCompleted() {
        FXMLLoader loginFXMLLoader = new FXMLLoader(getClass().getResource("/play.fxml"));
        try {
    ...
    public void loadSwitchUsers() {
        FXMLLoader loginFXMLLoader = new FXMLLoader(getClass().getResource("/users.fxml"));
        try {
    ...
    public void openOptions() {
        FXMLLoader loginFXMLLoader = new FXMLLoader(getClass().getResource("/options.fxml"));
        try {
